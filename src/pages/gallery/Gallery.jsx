...
const Gallery = () => {
    ...
    return [
      {
        ...
        description:
          "A perfect day at the beach with the family. The weather was amazing!",
      },
      {
        id: 2,
        url: hike,
        ...
        description:
          "Challenging hike but the view at the top was worth every step.",
      },
      {
        id: 3,
        url: sunset,
      ...
      },
      {
        ...
        description:
          "Three days of camping in the wilderness. So peaceful and refreshing.",
      },
      {
        id: 6,
        url: icecream,
      ...
      },
      {
        ...
        description:
          "Fourth of July fireworks display was absolutely spectacular.",
      },
      {
        id: 8,
        url: volley,
  ...
  const handleFilter = (filters) => {
    ...
    if (filters.dateRange.start) {
      filtered = filtered.filter(
        (photo) => new Date(photo.date) >= new Date(filters.dateRange.start)
      );
    }
    if (filters.dateRange.end) {
      filtered = filtered.filter(
        (photo) => new Date(photo.date) <= new Date(filters.dateRange.end)
      );
    }
      ...
      <div className={styles.galleryHeader}>
        <div className={styles.headerContent}>
          ...
          <p className={styles.pageSubtitle}>
            ...
            {filteredPhotos.length === 1 ? "memory" : "memories"} captured
          </p>
        </div>
